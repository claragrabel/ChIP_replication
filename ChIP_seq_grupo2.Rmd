...
Las muestras han sido procesadas mediante secuenciación de altas prestaciones (Illumina HiSeq 2500).

## Flujo de trabajo

![Flujo de trabajo](ChIP_seq_workflow.jpg)

(Omitiría la preparación del espacio de trabajo creo)
...
(Scripts de procesamiento si que lo dejaría: análisis de calidad y mapeado)
